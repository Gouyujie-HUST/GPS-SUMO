    ...
    <body style="overflow-x: hidden">
        ...
        <div class="banner">
          ...
          <ul class="lavaLampWithImage" id="gbnav">
            ...
            <li class="current"><a href="contact.php" style="width:110px">CONTACT</a></li>
          </ul>
                    </div>
                </div>
            </div>
...
$("#tools1").addClass("closed");
				...
				<div id="content">
                    <div id="contentkk" class="story"><br />
                        ...
                        <h2 id="pageName">&#8251; Contact:</h2>

                        
      <div style="width: 99%; height:700px "> 
        <p align="justify"><font color="#971c13"><strong>Yu Xue</strong></font>, Ph. D., Professor<br/>
          Email: <a href="mailto:xueyu@hust.edu.cn">xueyu@hust.edu.cn</a><br/>
